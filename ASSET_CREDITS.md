...
- **`assets/metroid-prime.png`** — Metroid Prime logo. © Nintendo; in the **public domain**
  ...
  Used decoratively as the "now playing" mark on the dev side. Not affiliated with or endorsed
  by Nintendo.
- **`assets/dropcaps/GoudyInitialen-*.ttf`** — Goudy Initialen ornamental initials (vendored from
  the `ai-poetry` project) for article drop caps.
- **`assets/logo-ak*.png`, `favicon.svg`, `stamp.svg`, `heart-pin.svg`, `monogram.svg`,
  `asterism.svg`** — Arslan Kazmi design-system brand marks.
